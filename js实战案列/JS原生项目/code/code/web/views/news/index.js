...
search.oninput =async function(){
    ...
    <li class="list-group-item"><a href="js实战案列/JS原生项目/code/code/web/views/detail/index.html?id=${item.id}">${item.title}</a></li>
    `).join("")
}
...
function renderTab(){
    ...
    tabs.forEach((item,index)=>{
        ...
        item.onclick = function(evt){
            ...
            location.href=`js实战案列/JS原生项目/code/code/web/views/detail/index.html?id=${evt.target.dataset.id}`
        }
    })
